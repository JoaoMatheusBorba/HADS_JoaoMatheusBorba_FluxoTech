            ...
            <FormControl fullWidth variant="outlined">
              ...
              <Select
                ...
                renderValue={(selected) => {
                  if (selected === "") return <em>Todos os Produtos</em>;
                  const p = products.find(prod => prod.id === selected);
                  return p ? p.nome : '';
                }}
              >
          ...
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth variant="outlined">
              ...
              <Select
                ...
                renderValue={(selected) => {
                  if (selected === "") return <em>Todos os Tipos</em>;
                  return selected === 'ENTRADA' ? 'Compras' : 'Vendas';
                }}
              >
